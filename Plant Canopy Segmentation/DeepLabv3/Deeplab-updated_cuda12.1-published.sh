...
EPOCH_NUM="30" # Number of epochs for training
BATCH_SIZE="8" #Batch size for training 
BASE_RATE="0.00025" #Base learning rate 
CROP_SIZE="512"
RESUME="None"
WORKERS="3"
CLASS_NUM="3"
ALL= false
PROG_VALUE="" # 1 for Convert_to_rgb , 2 for Tiling , 3 for training grape, 4 for implementation/inference, 5 for training hemp
INF_MOD_PATH=""
...
case $PROG_VALUE in 
    ...
    docker run \
			...
			--crop_size ${CROP_SIZE} --resume ${RESUME} --workers ${WORKERS} --num_classes ${CLASS_NUM}\
